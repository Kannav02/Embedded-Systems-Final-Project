...
void setup(){
    ...
    datetime.tm_hour = 21;      // Hour (24-hour format)
    datetime.tm_mday = 23;      // Day of the month
    datetime.tm_mon = 2;        // Month (0-11, so February is 1)
